...
export function Welcome({
  title = "Queridos Amigos e Familiares",
  text = "Com a bênção de Deus e o carinho das nossas famílias, temos a imensa alegria de convidar-vos para celebrar connosco o dia em que uniremos as nossas vidas. A vossa presença é o maior presente e completará a nossa felicidade nesta linda celebração de amor."
}: WelcomeProps) {
  return (
    <section className="py-24 px-6 bg-[#FAF6F0] relative overflow-hidden text-center border-b border-[#E0D8D0]/30">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl italic font-light text-[#5C131D]">{title}</h2>
